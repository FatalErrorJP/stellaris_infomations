...
| artillery(砲撃戦術) | median                 | median             | median                       | maintain_distance   | stay_at_range        | -
...
検証していませんが、Cがmedianであることを考えると射程延長の補正でAがmedianの以上にはならない可能性があります。
