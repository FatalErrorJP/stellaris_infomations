...
| video::2lQyvYkf6oI/PL80uh3ENsGgbDmt5nZO79Jl8AvbHP8C4s[youtube, width=400, height=225]
| video::FiJRVkopLGA/PL80uh3ENsGgbDmt5nZO79Jl8AvbHP8C4s[youtube, width=400, height=225]
| video::ht_1XQRi_UA/PL80uh3ENsGgbDmt5nZO79Jl8AvbHP8C4s[youtube, width=400, height=225]
| video::x5Difc5NSi8/PL80uh3ENsGgbDmt5nZO79Jl8AvbHP8C4s[youtube, width=400, height=225]
|===
...
| default(混合戦術)   | median                 | 10                 | 500                          | none                | orbit                | -
| swarm(突進戦術)     | min                    | min                | 1500                         | orbit               | charge               | -
| picket(前哨戦術)    | median                 | median             | 250                          | stay_at_range       | orbit                | -
| line(戦列戦術)      | median                 | median             | 500                          | stay_at_range       | charge               | -
| artillery(砲撃戦術) | max                    | max                | 1000                         | maintain_distance   | stay_at_range        | -
| carrier(空母戦術)   | max                    | max                | 1000                         | maintain_distance   | stay_at_range        | strike_craft
| torpedo(魚雷戦術)   | 10                     | 10                 | 1200                         | charge              | charge               | -
|===
--
...
=== 各戦術の挙動のまとめ
定義値と、実際にゲーム内で動かしてみた結果を参考にまとめた各戦術の挙動について、以下に記載します。


==== 混合戦術
混合戦術は、距離10まで前進した後、10の距離を保ったままぐるぐる回るような挙動になります。

image::ship_behaviors_12.png[width=100%]
...
==== 魚雷戦術
魚雷戦術は、常に敵艦に向かって一直線に前進します。特記事項は特にありません。
...
[.scrollable]
--
[options="autowidth,header", role=stretch]
.SWARM(突進戦術)のAの距離の目安
|===
| 艦船武器射程＼minの武器射程 | 30     | 60      | 100     | 120
| 補正なし(1倍)               | 25.950 | 51.900  | 86.500  | 103.800
| 艦船武器射程+10%(1.1倍)     | 28.545 | 57.090  | 95.150  | 114.180
| 艦船武器射程+20%(1.2倍)     | 31.140 | 62.280  | 103.800 | 124.560
| 艦船武器射程+30%(1.3倍)     | 33.735 | 67.470  | 112.450 | 134.940
| 艦船武器射程+40%(1.4倍)     | 36.330 | 72.660  | 121.100 | 145.320
| 艦船武器射程+50%(1.5倍)     | 38.925 | 77.850  | 129.750 | 155.700
| 艦船武器射程+60%(1.6倍)     | 41.520 | 83.040  | 138.400 | 166.080
| 艦船武器射程+70%(1.7倍)     | 44.115 | 88.230  | 147.050 | 176.460
| 艦船武器射程+80%(1.8倍)     | 46.710 | 93.420  | 155.700 | 186.840
| 艦船武器射程+90%(1.9倍)     | 49.305 | 98.610  | 164.350 | 197.220
| 艦船武器射程+100%(2倍)      | 51.900 | 103.800 | 173.000 | 207.600
|===
--
...
--
[options="autowidth,header", role=stretch]
.picket(前哨戦術)および、line(戦列戦術)のAの距離の目安
|===
| 艦船武器射程＼medianの武器射程 | 30     | 60     | 100     | 120
| 補正なし(1倍)                  | 19.050 | 38.100 | 63.500  | 76.200
| 艦船武器射程+10%(1.1倍)        | 20.955 | 41.910 | 69.850  | 83.820
| 艦船武器射程+20%(1.2倍)        | 22.860 | 45.720 | 76.200  | 91.440
| 艦船武器射程+30%(1.3倍)        | 24.765 | 49.530 | 82.550  | 99.060
| 艦船武器射程+40%(1.4倍)        | 26.670 | 53.340 | 88.900  | 106.680
| 艦船武器射程+50%(1.5倍)        | 28.575 | 57.150 | 95.250  | 114.300
| 艦船武器射程+60%(1.6倍)        | 30.480 | 60.960 | 101.600 | 121.920
| 艦船武器射程+70%(1.7倍)        | 32.385 | 64.770 | 107.950 | 129.540
| 艦船武器射程+80%(1.8倍)        | 34.290 | 68.580 | 114.300 | 137.160
| 艦船武器射程+90%(1.9倍)        | 36.195 | 72.390 | 120.650 | 144.780
| 艦船武器射程+100%(2倍)         | 38.100 | 76.200 | 127.000 | 152.400
|===
--
...
--
[options="autowidth,header", role=stretch]
.artillery(砲撃戦術)のBの距離の目安
|===
| 艦船武器射程＼maxの武器射程 | 100    | 120    | 150    | 250
| 補正なし(1倍)               | 75.00  | 90.00  | 112.50 | 187.50
| 艦船武器射程+10%(1.1倍)     | 82.50  | 99.00  | 123.75 | 206.25
| 艦船武器射程+20%(1.2倍)     | 90.00  | 108.00 | 135.00 | 225.00
| 艦船武器射程+30%(1.3倍)     | 97.50  | 117.00 | 146.25 | 243.75
| 艦船武器射程+40%(1.4倍)     | 105.00 | 126.00 | 157.50 | 262.50
| 艦船武器射程+50%(1.5倍)     | 112.50 | 135.00 | 168.75 | 281.25
| 艦船武器射程+60%(1.6倍)     | 120.00 | 144.00 | 180.00 | 300.00
| 艦船武器射程+70%(1.7倍)     | 127.50 | 153.00 | 191.25 | 318.75
| 艦船武器射程+80%(1.8倍)     | 135.00 | 162.00 | 202.50 | 337.50
| 艦船武器射程+90%(1.9倍)     | 142.50 | 171.00 | 213.75 | 356.25
| 艦船武器射程+100%(2倍)      | 150.00 | 180.00 | 225.00 | 375.00
|===
--
...
--
[options="autowidth,header", role=stretch]
.artillery(砲撃戦術)のAの距離の目安
|===
| 艦船武器射程＼maxの武器射程 | 100   | 120   | 150   | 250
| 補正なし(1倍)               | 50.0  | 60.0  | 75.0  | 125.0
| 艦船武器射程+10%(1.1倍)     | 55.0  | 66.0  | 82.5  | 137.5
| 艦船武器射程+20%(1.2倍)     | 60.0  | 72.0  | 90.0  | 150.0
| 艦船武器射程+30%(1.3倍)     | 65.0  | 78.0  | 97.5  | 162.5
| 艦船武器射程+40%(1.4倍)     | 70.0  | 84.0  | 105.0 | 175.0
| 艦船武器射程+50%(1.5倍)     | 75.0  | 90.0  | 112.5 | 187.5
| 艦船武器射程+60%(1.6倍)     | 80.0  | 96.0  | 120.0 | 200.0
| 艦船武器射程+70%(1.7倍)     | 85.0  | 102.0 | 127.5 | 212.5
| 艦船武器射程+80%(1.8倍)     | 90.0  | 108.0 | 135.0 | 225.0
| 艦船武器射程+90%(1.9倍)     | 95.0  | 114.0 | 142.5 | 237.5
| 艦船武器射程+100%(2倍)      | 100.0 | 120.0 | 150.0 | 250.0
|===
--
...
--
[options="autowidth,header", role=stretch]
.carrier(空母戦術)のBの距離の目安
|===
| 艦船交戦距離＼Hスロットの艦船交戦距離 | 100    | 125
| 補正なし(1倍)                         | 75.00  | 93.75
| 艦船交戦距離+10%(1.1倍)               | 82.50  | 103.13
| 艦船交戦距離+20%(1.2倍)               | 90.00  | 112.50
| 艦船交戦距離+30%(1.3倍)               | 97.50  | 121.88
| 艦船交戦距離+40%(1.4倍)               | 105.00 | 131.25
| 艦船交戦距離+50%(1.5倍)               | 112.50 | 140.63
| 艦船交戦距離+60%(1.6倍)               | 120.00 | 150.00
| 艦船交戦距離+70%(1.7倍)               | 127.50 | 159.38
| 艦船交戦距離+80%(1.8倍)               | 135.00 | 168.75
| 艦船交戦距離+90%(1.9倍)               | 142.50 | 178.13
| 艦船交戦距離+100%(2倍)                | 150.00 | 187.50
|===
--
...
--
[options="autowidth,header", role=stretch]
.carrier(空母戦術)のAの距離の目安
|===
| 艦船交戦距離＼Hスロットの艦船交戦距離 | 100   | 125.0
| 補正なし(1倍)                         | 50.0  | 62.5
| 艦船交戦距離+10%(1.1倍)               | 55.0  | 68.8
| 艦船交戦距離+20%(1.2倍)               | 60.0  | 75.0
| 艦船交戦距離+30%(1.3倍)               | 65.0  | 81.3
| 艦船交戦距離+40%(1.4倍)               | 70.0  | 87.5
| 艦船交戦距離+50%(1.5倍)               | 75.0  | 93.8
| 艦船交戦距離+60%(1.6倍)               | 80.0  | 100.0
| 艦船交戦距離+70%(1.7倍)               | 85.0  | 106.3
| 艦船交戦距離+80%(1.8倍)               | 90.0  | 112.5
| 艦船交戦距離+90%(1.9倍)               | 95.0  | 118.8
| 艦船交戦距離+100%(2倍)                | 100.0 | 125.0
|===
--
